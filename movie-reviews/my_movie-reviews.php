 ...
 * @copyright         2022 Julian Mercado
 * @license           GPL-2.0-or-later
 *
 * @wordpress-plugin
 * Plugin Name:       Movie Reviews
 * Plugin URI:        https://example.com/plugin-name
 * Description:       Add new custom post type to wordpress core.
 * Version:           1.0.0
...
class My_Movie_Reviews {
  ...
  const CPT_SLUG = 'movie_review';
    ...
    // initialize Movie Type Taxonomies for Movie Reviews
    ...
    // Add custom template and stylesheet for a single movie review page
  ...
  /***
   * 
   *  Register the Movie Review Taxonomies
   * 
   *  Defined statically for use in activation hook
   */
  public static function register_taxonomies() {
    register_taxonomy( 'movie_types', array(self::CPT_SLUG), array(
      'labels' => array(
				'name' => __('Movie Types'),
  ...
  /**
   * Enqueue the stylsheet for the movie review post type
   */
  function add_styles_scripts() {
    wp_enqueue_style('movie-review-style', plugin_dir_url(__FILE__).'css/style.css');
  }
